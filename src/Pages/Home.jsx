...
function Main({ user }) {
  ...
  return (
    <section className="pt-20 flex flex-col justify-center text-center">
      <div className="text-white my-10 flex flex-col items-center mt-52 ">
          <div className="flex flex-col items-center justify-center">
          <div className="welcome-text m-2 font-knewave flex font-extrabold text-center mb-12 justify-center">
        ...
        {Object.keys(user).length == 0 ?  <div className="main-text mt-5">You must be <button className="text-blue-500" onClick={() => {navigate("login")}}>Log In</button> to upload image.</div> : null}
